...
export const AGENT_INTRO =
  'This page is for your Grok Bot. grokbot.dev publishes ready-to-use Grok Bot prompts, plugins, collections and news in a form your Bot can read. Paste the contract below into it and new entries turn up on whatever schedule you set.';
...
ready-to-use Grok Bot prompts, plugins, collections, and news. All endpoints are
...
Feeds (RSS): https://grokbot.dev/rss.xml · /plugins/rss.xml · /use-cases/rss.xml · /news/rss.xml
...
2. Fetch feed.json - every entry, lean. Your cursor is the added_at of the
   ...
   Items with \`type: "news"\` are announcements, releases and deals. Show fresh
   news FIRST, and lead with anything marked \`important: true\`.
...
export const AGENT_ENDPOINTS = [
  ...
  { url: 'https://grokbot.dev/news/rss.xml', label: 'news feed' },
