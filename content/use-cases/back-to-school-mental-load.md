...
3. Give it the context it needs — the accounts, files, and rules specific to your setup — so it can work the way Stella used Grok Bot on her back-to-school emails and to-dos for multiple kids, plus other household jobs it handled independently that week
