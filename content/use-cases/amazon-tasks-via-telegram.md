...
3. Give it the context it needs — the accounts, files, and rules specific to your setup — so it can work the way Same tweet: Amazon tasks with a Telegram hookup so he can tap the bot from his phone.
