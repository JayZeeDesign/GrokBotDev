...
3. Give it the context it needs — the accounts, files, and rules specific to your setup — so it can work the way Darian told Grok Bot to pay its own fee: it scanned email for lost money and emailed five merchants that never refunded his returns — alread
