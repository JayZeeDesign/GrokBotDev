...
3. Give it the context it needs — the accounts, files, and rules specific to your setup — so it can work the way Same Matthew Berman tweet: the bot handled calendar conflict scheduling.
