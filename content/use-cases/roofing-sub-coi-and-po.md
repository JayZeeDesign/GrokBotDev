...
3. Give it the context it needs — the accounts, files, and rules specific to your setup — so it can work the way Same contractor run: it found a discrepancy in subcontractor insurance certificates and drafted/sent email to their brokers; wrote a work or
