...
3. Give it the context it needs — the accounts, files, and rules specific to your setup — so it can work the way In the same GTM article, Krista automates follow-up drafts from Granola or Gong notes after external calls. Drafts only — grounded in what w
