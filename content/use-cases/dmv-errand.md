...
3. Give it the context it needs — the accounts, files, and rules specific to your setup — so it can work the way Same tweet: he had it handle DMV registration — the boring civic errand agents are actually good at.
