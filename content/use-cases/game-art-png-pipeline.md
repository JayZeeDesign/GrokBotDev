...
3. Give it the context it needs — the accounts, files, and rules specific to your setup — so it can work the way A game developer had Grok Bot drive his custom art-gen webpage to generate game art assets and prep them as transparent PNGs in a consistent
